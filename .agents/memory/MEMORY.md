...
- [Google API rate limits](google-api-rate-limits.md) — Sheets caps ~10 reads/sec; all Google connector calls must use the shared throttled+retry helper (rate errors arrive as 500s, not 429s).
